...
export function NavigationBar({
  ...
  const activeTab =
    location.pathname === "/following" ? "following" : "discover";
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-white/10">
        <div className="max-w-[1600px] mx-auto px-6">
          ...
          <div className="h-16 flex items-center justify-between">
            ...
            <Link
              to="/"
              className="text-white tracking-wider hover:opacity-70 transition-opacity"
            >
              DESIGNER
            </Link>
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-2 -right-2 min-w-[18px] h-[18px] bg-white text-black text-[10px] font-bold rounded-full flex items-center justify-center px-1">
